...
import { AuthModal } from "@/components/sign-signup"
...
export function Header() {
  ...
  const [isMultiStepBookingOpen, setIsMultiStepBookingOpen] = useState(false)
  ...
  const handleBookNowClick = useCallback(() => {
    setIsMultiStepBookingOpen(true)
    setIsMenuOpen(false)
  }, [])
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showNotification && (
          <motion.div
            ...
            className={`fixed top-0 left-0 right-0 z-[9999] text-white py-3 px-4 text-center font-medium shadow-lg ${
        ...
        <div className="relative z-10">
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col sm:flex-row items-center justify-between h-auto sm:h-10 py-2 sm:py-0 text-sm">
                {/* Left: Contact Info */}
                <div
                ...
                >
                  ...
                  {userType === "trainer" && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs sm:text-sm">Instructor Portal</span>
                    </div>
                  )}
                </div>
              ...
              <nav className="hidden md:flex items-center space-x-4 lg:space-x-8">
                        ...
                        >
                          ...
                          {unreadCount > 0 && (
                            <div className="absolute -top-1 -right-1 pointer-events-none">
                              <Badge className="bg-red-500 hover:bg-red-600 text-white text-xs min-w-[20px] h-5 flex items-center justify-center rounded-full px-1">
                                {unreadCount > 9 ? "9+" : unreadCount}
                              </Badge>
                            </div>
                          )}
                          {unreadCount > 0 && (
                            <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full opacity-75 pointer-events-none animate-pulse" />
                          )}
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent
                        align="end"
                        className="w-80 bg-white rounded-xl shadow-2xl border border-gray-200 p-0 overflow-hidden max-h-96"
                        sideOffset={8}
                      >
                        {/* Header */}
                        <div
                ...
                {!isLoggedIn ? (
                  <div>
                    <Button
                      variant="ghost"
                      className={`px-0 font-medium transition-colors duration-200 group text-sm lg:text-base ${
                        userType === "trainer"
                          ? "text-gray-800 hover:text-purple-600"
                          : "text-gray-800 hover:text-emerald-600"
                      }`}
                  ...
                  <div>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="w-64 bg-white rounded-xl shadow-2xl border border-gray-200 p-0 overflow-hidden"
                        sideOffset={8}
                      >
                        {/* User info header */}
                        <div
              ...
              <div className="md:hidden flex items-center space-x-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      ...
                      >
                        ...
                        {unreadCount > 0 && (
                          <div className="absolute -top-1 -right-1 pointer-events-none">
                            <Badge className="bg-red-500 hover:bg-red-600 text-white text-xs min-w-[18px] h-4 flex items-center justify-center rounded-full px-1">
                              {unreadCount > 9 ? "9+" : unreadCount}
                            </Badge>
                          </div>
                        )}
                ...
                <div>
                  <Button
                    ...
                    className={`relative w-10 h-10 sm:w-12 sm:h-12 rounded-xl transition-all duration-200 text-gray-800 ${
                      userType === "trainer" ? "hover:bg-purple-50" : "hover:bg-emerald-50"
                    }`}
                  >
          ...
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
                ...
                className={`md:hidden absolute top-full left-0 right-0 z-[1000] bg-white shadow-2xl ${
                    ...
                    <div className="flex flex-col space-y-1">
                      {navItems.map((item, index) => (
                        <div key={item.name}>
                          <Link
                            href={item.href}
                            className={`flex items-center space-x-3 px-4 py-4 rounded-xl text-gray-800 font-medium transition-all duration-200 border border-transparent ${
                              userType === "trainer"
                    ...
                    <div className="mt-6 space-y-3 px-4">
                      {!isLoggedIn ? (
                        <div>
                          <Button
                            variant="outline"
                            className={`w-full py-4 rounded-xl border-2 font-semibold text-base bg-transparent transition-all duration-200 ${
                              userType === "trainer"
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            {userType === "trainer" ? (
                              <GraduationCap
                                className={`w-5 h-5 ${userType === "trainer" ? "text-purple-600" : "text-emerald-600"}`}
                              />
                            ) : (
                              <Sparkles
                                className={`w-5 h-5 ${userType === "trainer" ? "text-purple-600" : "text-emerald-600"}`}
                          ...
                          <button
                            ...
                            className="flex items-center space-x-3 px-4 py-4 rounded-xl hover:bg-red-50 text-red-600 font-medium transition-all duration-200 border border-transparent hover:border-red-200 w-full text-left"
                          >
                            <X className="w-5 h-5" />
                            <span>Sign Out</span>
                          </button>
      ...
      {/* Multi-Step Booking */}
      <MultiStepBooking isOpen={isMultiStepBookingOpen} onClose={() => setIsMultiStepBookingOpen(false)} />
